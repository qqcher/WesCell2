...
```
  ...
  Once this function is inputted, the console will prompt you with the question "What is the name of the new variable?" To which, you can simply reply with the name of the variable without or without quotation marks. The example picutre is above
